...
- Inversion of SHA1? or SHA256? https://github.com/vsklad/cgen.
...
cd slime
x86_64-w64-mingw32-g++ -std=c++98 -O3 -I./include -I./ src/*.cc -o bin/slime_cli-w64 -D __STDC_LIMIT_MACROS -D __STDC_FORMAT_MACROS -LOG -static
